          ...
          <MyForm
            columns={[
              ...
              { name: 'experience', type: 'text', defaultValue: experience?.experience },
              {
                name: 'positivePoint',
                type: 'number',
                defaultValue: experience?.positivePoint,
                required: true,
                min: 0,
                max: 10
              },
              {
                name: 'negativePoint',
                type: 'number',
                defaultValue: experience?.negativePoint,
                required: true,
                min: 0,
                max: 10
              },
            ...
            cancelRedirectTo="/dashboard/experiences"
          />
        </div>
        <div className="w-1/2">
          <MyTable id="resumeId" columns={['startDate', 'endDate', 'belongsTo']} dataSource={resumes} />
        </div>
      </div>
    </>
  );
